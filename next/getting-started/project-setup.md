...
We now have a good **basic project configuration**, that we will build upon in the next chapters. In the next chapters, we will see how to [integrate WebGPU](../hello-webgpu.md) to our project, how to [initialize it](../adapter-and-device.md), and how to [open a window](../opening-a-window.md) into which to draw.
